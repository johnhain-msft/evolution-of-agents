...
**Generated by**:
- **Automated**: Post-provision hooks via `scripts/populate_env.sh` or `scripts/populate_env.ps1`
- **Manual**: Direct user creation
...
└── configure-office365-access.* # Office 365 access configuration
```
...
- Example: `populate_env.sh`, `populate_env.ps1`
